...
{
	flash_write_status_mid146085(data, FLASH_WRITE_STATUS_BP_MID146085);
}
...
{
	flash_write_status_mid146085(FLASH_LOCK_NONE_MID146085, FLASH_WRITE_STATUS_BP_MID146085);
}
